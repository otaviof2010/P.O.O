...
class Veiculo(abc.ABC):
    def _init_(self, modelo,piloto, velocidade_max, combustivel_max, combustivel_atual):
        self.modelo = modelo
        self.piloto = piloto
...
class Carro(Veiculo):
    def _init_(self, modelo, piloto, velocidade_max, combustivel_max, combustivel_atual):
        super()._init_(modelo,piloto, velocidade_max, combustivel_max, combustivel_atual)
        self.distancia = 0
